            ...
            <div class="flex items-center space-x-3">
              ...
              <div class="flex items-center space-x-2">
                <button @click="toggleMute" class="text-gray-400 hover:text-white">
                  <Icon v-if="isMuted || volume === 0" icon="mdi:volume-off" class="w-5 h-5" />
                  <Icon v-else-if="volume <= 0.4" icon="mdi:volume-low" class="w-5 h-5" />
                  <Icon v-else-if="volume > 0.4 && volume < 0.7" icon="mdi:volume-medium" class="w-5 h-5" />
                  <Icon v-else icon="mdi:volume-high" class="w-5 h-5" />
                </button>
                <input
                  type="range"
                  min="0"
